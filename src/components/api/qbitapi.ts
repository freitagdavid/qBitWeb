...
class Qbittorrent {
  ...
  async deleteTorrents(hashes: string[], deleteFiles = false) {
    return this.axiosClient.get(
      `/torrents/delete?hashes=${hashes.join(",")}&deleteFiles=${deleteFiles}`,
    );
  }
  ...
  async setTorrentLocation(hashes: string[], location: string) {
    return this.axiosClient.get(
      `/torrents/setLocation?hashes=${hashes.join(",")}&location=${location}`,
    );
  }
  ...
  async setTorrentCategory(hashes: string[], category: string) {
    return this.axiosClient.get(
      `/torrents/setCategory?hashes=${hashes.join(",")}&category=${category}`,
    );
  }
  ...
  async setAutomaticTorrentManagement(hashes: string[], enable: boolean) {
    return this.axiosClient.get(
      `/torrents/setAutoManagement?hashes=${hashes.join(",")}&enable=${enable}`,
    );
  }
  ...
  async setSuperSeeding(hashes: string[], value: boolean) {
    return this.axiosClient.get(
      `/torrents/setSuperSeeding?hashes=${hashes.join(",")}&value=${value}`,
    );
  }
